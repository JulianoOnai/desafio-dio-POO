...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos inscritos Juliano:" + devJuliano.getConteudosInscritos());
        devJuliano.progredir();
        System.out.println("-");
        devJuliano.progredir();
        System.out.println("Conteúdos inscritos Juliano:" + devJuliano.getConteudosInscritos());
        System.out.println("Conteúdos concluídos Juliano:" + devJuliano.getConteudosConcluidos());
